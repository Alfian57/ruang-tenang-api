...
func SeedTestUsers(db *gorm.DB) error {
	...
	testUsers := []struct {
		...
		// These non-routable-looking numbers are presentation fixtures, not member
		// contact details. All seeded accounts are marked verified so they can
		// exercise the normal login flow without sending OTPs to real people.
		{Name: "Mitra Ruang Tenang", Email: presentationMitraEmail, WhatsAppNumber: "+6280000000001", Role: model.RoleMitra, Exp: 2200, GoldCoins: 900, Avatar: "avatar-1.jpg", Tagline: "Mengelola program wellbeing organisasi.", Bio: "Akun mitra tunggal untuk dashboard B2B dan presentasi juri.", CurrentStreak: 10, LongestStreak: 21, TotalActivities: 88, LoginStreak: 10},
		{Name: "Alfian Gading Saputra", Email: presentationGadingEmail, WhatsAppNumber: "+6280000000002", Role: model.RoleUser, Exp: 1600, GoldCoins: 1200, Avatar: "avatar-2.jpg", Tagline: "Mulai dari langkah kecil.", Bio: "User premium personal untuk validasi fitur komunitas dan billing.", CurrentStreak: 6, LongestStreak: 12, TotalActivities: 34, LoginStreak: 6},
		{Name: "Dery Wahyu Perdana", Email: presentationDeryEmail, WhatsAppNumber: "+6280000000003", Role: model.RoleUser, Exp: 980, GoldCoins: 720, Avatar: "avatar-3.jpg", Tagline: "Jalan pelan tapi konsisten.", Bio: "User premium melalui jalur B2B untuk simulasi seat organisasi.", CurrentStreak: 4, LongestStreak: 8, TotalActivities: 24, LoginStreak: 4},
		{Name: "Riki Andhika Kusna Putra", Email: presentationAndhikaEmail, WhatsAppNumber: "+6280000000004", Role: model.RoleUser, Exp: 420, GoldCoins: 180, Avatar: "avatar-4.jpg", Tagline: "Belajar mengenali diri tiap hari.", Bio: "User freemium untuk validasi limit dan onboarding pengguna gratis.", CurrentStreak: 1, LongestStreak: 4, TotalActivities: 10, LoginStreak: 1},
	}
