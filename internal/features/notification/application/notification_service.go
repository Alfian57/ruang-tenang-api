...
type NotificationService struct {
	...
	pushService *pushapp.PushService
}

func NewNotificationService(notifRepo *infrastructure.NotificationRepository) *NotificationService {
	return &NotificationService{notifRepo: notifRepo}
}

func (s *NotificationService) SetPushService(ps *pushapp.PushService) {
	s.pushService = ps
}
