...
type ExpHistoryHandler struct {
	expHistoryService  *application.ExpHistoryService
	levelConfigService *application.LevelConfigService
}

func NewExpHistoryHandler(expHistoryService *application.ExpHistoryService, levelConfigService *application.LevelConfigService) *ExpHistoryHandler {
