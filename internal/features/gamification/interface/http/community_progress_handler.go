...
type CommunityProgressHandler struct {
	communityService *application.CommunityProgressService
}

func NewCommunityProgressHandler(communityService *application.CommunityProgressService) *CommunityProgressHandler {
