...
import (
	...
	"github.com/Alfian57/ruang-tenang-api/internal/features/feature_unlock/application")

type FeatureUnlockHandler struct {
	featureService *application.FeatureUnlockService
}

func NewFeatureUnlockHandler(featureService *application.FeatureUnlockService) *FeatureUnlockHandler {
