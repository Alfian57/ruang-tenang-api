...
import (
	...
	"github.com/Alfian57/ruang-tenang-api/internal/features/daily_spin/application")

type DailySpinHandler struct {
	spinService *application.DailySpinService
}

func NewDailySpinHandler(spinService *application.DailySpinService) *DailySpinHandler {
