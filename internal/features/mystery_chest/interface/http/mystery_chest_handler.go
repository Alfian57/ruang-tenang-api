...
import (
	...
	"github.com/Alfian57/ruang-tenang-api/internal/features/mystery_chest/application")

type MysteryChestHandler struct {
	chestService *application.MysteryChestService
}

func NewMysteryChestHandler(chestService *application.MysteryChestService) *MysteryChestHandler {
