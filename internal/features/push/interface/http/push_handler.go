...
import (
	...
	"github.com/Alfian57/ruang-tenang-api/internal/features/push/application")

type PushHandler struct {
	pushService *application.PushService
}

func NewPushHandler(pushService *application.PushService) *PushHandler {
