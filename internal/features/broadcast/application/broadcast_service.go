...
import (
	...
	"github.com/Alfian57/ruang-tenang-api/internal/features/broadcast/infrastructure")

type BroadcastService struct {
	broadcastRepo  *infrastructure.BroadcastNotificationRepository
	pushRepo       *pushinfra.PushSubscriptionRepository
