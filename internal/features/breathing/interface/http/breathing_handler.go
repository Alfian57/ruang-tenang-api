...
import (
	...
	"github.com/Alfian57/ruang-tenang-api/internal/features/breathing/application")

type BreathingHandler struct {
	service application.BreathingService
}

func NewBreathingHandler(service application.BreathingService) *BreathingHandler {
