...
type InspiringStoryService struct {
	...
	badgeService        *badgeapp.BadgeService
...
// Custom errors
var (
	ErrStoryNotFound            = &serviceerror.ServiceError{Code: "STORY_NOT_FOUND", Message: "Cerita tidak ditemukan"}
	ErrStoryNotApproved         = &serviceerror.ServiceError{Code: "STORY_NOT_APPROVED", Message: "Cerita belum disetujui"}
	ErrCommentNotFound          = &serviceerror.ServiceError{Code: "COMMENT_NOT_FOUND", Message: "Komentar tidak ditemukan"}
	ErrUnauthorized             = &serviceerror.ServiceError{Code: "UNAUTHORIZED", Message: "Tidak memiliki akses"}
	ErrCannotEditPublishedStory = &serviceerror.ServiceError{Code: "CANNOT_EDIT_PUBLISHED", Message: "Tidak dapat mengedit cerita yang sudah dipublikasukan"}
	ErrMonthlyStoryLimitReached = &serviceerror.ServiceError{Code: "MONTHLY_LIMIT_REACHED", Message: "Kamu sudah mencapai batas maksimal cerita bulan ini"}
)
