...
type WeeklyLeagueHandler struct {
	leagueService *service.WeeklyLeagueService
}

func NewWeeklyLeagueHandler(leagueService *service.WeeklyLeagueService) *WeeklyLeagueHandler {
...
func (h *WeeklyLeagueHandler) GetOverview(c *gin.Context) {
	...
	if err != nil {
		switch err {
		case service.ErrLeagueSeasonNotFound:
