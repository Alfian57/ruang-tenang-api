...
func NewDailyTaskHandler(dailyTaskService service.DailyTaskService) *DailyTaskHandler {
...
// @Produce json
// @Security BearerAuth
// @Success 200 {object} dto.Response{data=service.DailyLoginResult}
// @Failure 401 {object} dto.Response
// @Failure 500 {object} dto.Response
...
// @Success 200 {object} dto.Response{data=service.ClaimResult}
...
func (h *DailyTaskHandler) ClaimTaskReward(c *gin.Context) {
	...
	if err != nil {
		...
		case service.ErrTaskNotCompleted:
			c.JSON(http.StatusBadRequest, dto.Response{
				Success: false,
...
// @Produce json
// @Security BearerAuth
// @Success 200 {object} dto.Response{data=service.ClaimAllResult}
// @Failure 401 {object} dto.Response
// @Failure 500 {object} dto.Response
...
// @Success 200 {object} dto.Response{data=service.TaskHistoryResult}
// @Failure 401 {object} dto.Response
// @Failure 500 {object} dto.Response
