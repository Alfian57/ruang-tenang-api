...
type XPBoostComboHandler struct {
	boostService *service.XPBoostComboService
}

func NewXPBoostComboHandler(boostService *service.XPBoostComboService) *XPBoostComboHandler {
