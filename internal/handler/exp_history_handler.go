...
type ExpHistoryHandler struct {
	expHistoryService  *service.ExpHistoryService
	levelConfigService *service.LevelConfigService
}

func NewExpHistoryHandler(expHistoryService *service.ExpHistoryService, levelConfigService *service.LevelConfigService) *ExpHistoryHandler {
