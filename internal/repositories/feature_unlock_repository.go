...
func (r *FeatureUnlockRepository) GetAllFeatureDefinitions() ([]models.FeatureDefinition, error) {
...
func (r *FeatureUnlockRepository) GetFeaturesByLevel(level int) ([]models.FeatureDefinition, error) {
	var features []models.FeatureDefinition
...
func (r *FeatureUnlockRepository) GetFeaturesUpToLevel(level int) ([]models.FeatureDefinition, error) {
	var features []models.FeatureDefinition
	err := r.db.Where("required_level <= ? AND is_active = ?", level, true).
		Order("required_level ASC, feature_key ASC").
		Find(&features).Error
...
func (r *FeatureUnlockRepository) GetFeatureByKey(key string) (*models.FeatureDefinition, error) {
...
func (r *FeatureUnlockRepository) GetFeatureByID(id uuid.UUID) (*models.FeatureDefinition, error) {
	var feature models.FeatureDefinition
...
func (r *FeatureUnlockRepository) CreateFeatureDefinition(feature *models.FeatureDefinition) error {
	return r.db.Create(feature).Error
}

// UpdateFeatureDefinition updates a feature definition
func (r *FeatureUnlockRepository) UpdateFeatureDefinition(feature *models.FeatureDefinition) error {
...
func (r *FeatureUnlockRepository) GetUserUnlockedFeatures(userID uint) ([]models.UserFeatureUnlock, error) {
	var unlocks []models.UserFeatureUnlock
...
func (r *FeatureUnlockRepository) IsFeatureUnlocked(userID uint, featureID uuid.UUID) bool {
	var count int64
	r.db.Model(&models.UserFeatureUnlock{}).
...
func (r *FeatureUnlockRepository) UnlockFeature(userID uint, featureID uuid.UUID) error {
	unlock := &models.UserFeatureUnlock{
		UserID:    userID,
		FeatureID: featureID,
	}
...
func (r *FeatureUnlockRepository) UnlockFeaturesForLevel(userID uint, level int) ([]models.FeatureDefinition, error) {
	...
	var newlyUnlocked []models.FeatureDefinition
...
func (r *FeatureUnlockRepository) GetNewlyAvailableFeatures(userID uint, oldLevel, newLevel int) ([]models.FeatureDefinition, error) {
	var features []models.FeatureDefinition
...
func (r *FeatureUnlockRepository) GetUserFeatureStats(userID uint) (int, int, error) {
	...
	r.db.Model(&models.FeatureDefinition{}).Where("is_active = ?", true).Count(&totalFeatures)

	var unlockedFeatures int64
	r.db.Model(&models.UserFeatureUnlock{}).Where("user_id = ?", userID).Count(&unlockedFeatures)

	return int(unlockedFeatures), int(totalFeatures), nil
}

// GetUpcomingFeatures returns features user will unlock at next levels
func (r *FeatureUnlockRepository) GetUpcomingFeatures(currentLevel int, limit int) ([]models.FeatureDefinition, error) {
	var features []models.FeatureDefinition
...
func (r *FeatureUnlockRepository) GetFeaturesByCategory(category string) ([]models.FeatureDefinition, error) {
	var features []models.FeatureDefinition
