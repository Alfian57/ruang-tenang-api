...
// Helper function
func (s *BadgeService) toBadgeDefinitionResponse(b models.BadgeDefinition) dto.BadgeDefinitionResponse {
...
// Custom errors
var (
	ErrBadgeNotFound      = &ServiceError{Code: "BADGE_NOT_FOUND", Message: "Badge tidak ditemukan"}
	ErrBadgeAlreadyEarned = &ServiceError{Code: "BADGE_ALREADY_EARNED", Message: "Badge sudah dimiliki"}
)
