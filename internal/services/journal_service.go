...
type JournalService struct {
	...
	settingsRepo  *repositories.JournalSettingsRepository
	accessLogRepo *repositories.JournalAIAccessLogRepository
	userMoodRepo  *repositories.UserMoodRepository
...
func (s *JournalService) toJournalResponse(j *models.Journal) *dto.JournalResponse {
...
func (s *JournalService) toJournalListResponse(j *models.Journal) dto.JournalListResponse {
	preview := j.Content
	if len(preview) > 150 {
		preview = preview[:150] + "..."
	}
...
func (s *JournalService) generateJournalSummary(journals []models.Journal) (string, error) {
...
func (s *JournalService) generateWeeklySummary(journals []models.Journal) (string, []string, []string, []string, string) {
	if s.genaiClient == nil || len(journals) == 0 {
...
func (s *JournalService) exportToTXT(journals []models.Journal) string {
...
func (s *JournalService) exportToHTML(journals []models.Journal) string {
	var builder strings.Builder
