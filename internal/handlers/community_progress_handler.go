...
type CommunityProgressHandler struct {
	communityService *services.CommunityProgressService
}

func NewCommunityProgressHandler(communityService *services.CommunityProgressService) *CommunityProgressHandler {
