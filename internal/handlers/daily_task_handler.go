...
func NewDailyTaskHandler(dailyTaskService services.DailyTaskService) *DailyTaskHandler {
...
// @Produce json
// @Security BearerAuth
// @Success 200 {object} dto.Response{data=models.DailyTaskSummary}
...
// @Produce json
// @Security BearerAuth
// @Success 200 {object} dto.Response{data=services.DailyLoginResult}
// @Failure 401 {object} dto.Response
// @Failure 500 {object} dto.Response
...
// @Success 200 {object} dto.Response{data=services.ClaimResult}
...
func (h *DailyTaskHandler) ClaimTaskReward(c *gin.Context) {
	...
	if err != nil {
		...
		case services.ErrTaskNotCompleted:
			c.JSON(http.StatusBadRequest, dto.Response{
				Success: false,
				Message: "Task belum selesai",
			})
		case services.ErrTaskAlreadyClaimed:
			c.JSON(http.StatusBadRequest, dto.Response{
				Success: false,
...
// @Produce json
// @Security BearerAuth
// @Success 200 {object} dto.Response{data=services.ClaimAllResult}
// @Failure 401 {object} dto.Response
// @Failure 500 {object} dto.Response
...
// @Success 200 {object} dto.Response{data=services.TaskHistoryResult}
// @Failure 401 {object} dto.Response
// @Failure 500 {object} dto.Response
