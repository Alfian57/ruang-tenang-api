...
DeepSeek dipakai untuk chat/moderation/journal/wellness, Duitku Pop untuk payment, VAPID untuk push, storage untuk upload, dan golang-migrate untuk schema. Semua credential dibaca dari environment.
